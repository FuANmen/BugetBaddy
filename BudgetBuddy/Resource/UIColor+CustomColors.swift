...
extension UIColor {
    ...
    static let balanceMedium = UIColor(red: 144/255, green: 238/255, blue: 144/255, alpha: 1.0) // ライトグリーン
    static let balanceLow = UIColor(red: 154/255, green: 205/255, blue: 50/255, alpha: 1.0) // イエローグリーン
    static let balanceVeryLow = UIColor(red: 255/255, green: 165/255, blue: 0/255, alpha: 1.0) // オレンジ
}
