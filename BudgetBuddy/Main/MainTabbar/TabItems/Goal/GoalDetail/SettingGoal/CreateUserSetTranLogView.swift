//
//  CreateUserSetTranLogView.swift
//  BudgetBuddy
//
...
class CreateUserSetTranLogView: UIView {
    ...
    weak var delegate: CreateUserSetTranLogDelegate?
    ...
    func setInit(category: Category) {
    ...
    @objc private func okButtonTapped() {
        ...
        // 登録
        let target = UserSetTransferLog(title: self.titleLabel.text!, amount: Double(amountLabel.text!)!)
        UserSetTransferLogDao().createUserSetTransferLog(userSetTransferLog: target, category: self.category!)
        // OK押下後のイベント発火
        delegate?.okButtonTapped_atCreateUserSetTranLog()
    }
    
    @objc private func cancelButtonTapped() {
        delegate?.cancelButtonTapped_atCreateUserSetTranLog()
    }
}
